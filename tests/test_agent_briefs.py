from factor_lab.agent_briefs import build_failure_analyst_brief, build_planner_agent_brief, build_repair_agent_brief
...
def test_failure_analyst_brief_requires_research_failure_taxonomy(tmp_path):
    output = tmp_path / "failure_brief.json"
    payload = build_failure_analyst_brief({"recent_research_tasks": []}, {"open_questions": []}, {}, output)
