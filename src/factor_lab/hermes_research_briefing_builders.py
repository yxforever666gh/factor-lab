...
RESEARCHER_PROFILE_SCHEMA_VERSION = "factor_lab.researcher_profile_brief.v1"
DIAGNOSTICIAN_SCHEMA_VERSION = "factor_lab.diagnostician_brief.v1"
...
def build_researcher_profile_brief(
    ...
    payload = {
        "schema_version": RESEARCHER_PROFILE_SCHEMA_VERSION,
...
def build_diagnostician_brief(
    ...
    payload = {
        "schema_version": DIAGNOSTICIAN_SCHEMA_VERSION,
        "generated_at_utc": _iso_now(),
