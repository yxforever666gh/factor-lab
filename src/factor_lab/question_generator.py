...
def build_research_questions(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    if stable_candidates:
        questions.append({
            ...
            "sources": ["stable_candidates", "analyst_feedback_context"],
        })
    ...
    if latest_graveyard:
        questions.append({
            ...
            "sources": ["latest_graveyard", "analyst_signals", "analyst_feedback_context"],
        })
    ...
    for row in family_summary[:6]:
        ...
        if family_learning.get("recommended_action") == "upweight":
            questions.append({
                ...
                "sources": ["research_learning", "family_summary"],
            })

    llm_feedback = (feedback.get("llm_execution_feedback") or {}).get("retrospective") or {}
    if llm_feedback.get("core_candidates_lost"):
        questions.append({
            ...
            "sources": ["llm_retrospective", "analyst_feedback_context"],
        })
